# Unit Billing Admin Application Manual

---
## 📄 Changelog
| Version | Date | Description               | Authors  |
|---------|------|---------------------------|----------|
| 1.0 | 2026-05-20 | Initial admin manual view | [m000gg](https://github.com/m000gg) |
...
4. [Core Features (How to do X)](#-core-features)
...
---
*Didn't find the answer to your question or encountered a bug? Please open an issue in the official repository.*
