...
echo "=== 6. Nginx reverse proxy (single Spring Boot monolith on :8080) ==="
...
server {
    ...
    # Whole app (/login, /css/**, /admin/, /client/, ...) goes to the monolith,
    # original URI is preserved (no trailing slash in proxy_pass)
    location / {
